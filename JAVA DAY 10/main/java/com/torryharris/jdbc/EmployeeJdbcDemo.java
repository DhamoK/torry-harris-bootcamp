...
public class EmployeeJdbcDemo {
    public static void main(String[] args) {
        ...
        public static ArrayList<Employee> getEmployees(){
            Employee e1 = new Employee(5001, 2012, "RAVI", "DBA", 25000);
            Employee e2 = new Employee(5003, 2013, "KUMAR", "QA", 32000);
            Employee e3 = new Employee(5002, 2017, "SANKAR", "SUPPORT", 20000);
